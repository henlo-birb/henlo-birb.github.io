...
})({"bsZ6J":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4a236f9275d0a351";
module.bundle.HMR_BUNDLE_ID = "ca9e5de00afb955d";
"use strict";
...
},{}],"f5mCP":[function(require,module,exports) {
(function(global, factory) {
    ...
    ***************************************************************************** */ /* global Reflect, Promise */ var extendStatics = function(d, b) {
    ...
    /* @flow */ var LETTER_NUMBER_MODIFIER = 50;
    ...
    var calculateRadius = function(gradient, x, y, width, height) {
        ...
        switch(gradient.size){
            case CSSRadialExtent.CLOSEST_SIDE:
                ...
                if (gradient.shape === CSSRadialShape.CIRCLE) rx = ry = Math.min(Math.abs(x), Math.abs(x - width), Math.abs(y), Math.abs(y - height));
            ...
            case CSSRadialExtent.CLOSEST_CORNER:
                ...
                if (gradient.shape === CSSRadialShape.CIRCLE) rx = ry = Math.min(distance(x, y), distance(x, y - height), distance(x - width, y), distance(x - width, y - height));
                else if (gradient.shape === CSSRadialShape.ELLIPSE) {
            ...
            case CSSRadialExtent.FARTHEST_SIDE:
                ...
                if (gradient.shape === CSSRadialShape.CIRCLE) rx = ry = Math.max(Math.abs(x), Math.abs(x - width), Math.abs(y), Math.abs(y - height));
                else if (gradient.shape === CSSRadialShape.ELLIPSE) {
            ...
            case CSSRadialExtent.FARTHEST_CORNER:
                ...
                if (gradient.shape === CSSRadialShape.CIRCLE) rx = ry = Math.max(distance(x, y), distance(x, y - height), distance(x - width, y), distance(x - width, y - height));
                else if (gradient.shape === CSSRadialShape.ELLIPSE) {
        ...
        textList.forEach(function(text) {
            if (styles.textDecorationLine.length || text.trim().length > 0) {
                if (FEATURES.SUPPORT_RANGE_BOUNDS) {
                    if (!FEATURES.SUPPORT_WORD_BREAKING) textBounds.push(new TextBounds(text, Bounds.fromDOMRectList(context, createRange(node, offset, text.length).getClientRects())));
                    else textBounds.push(new TextBounds(text, getRangeBounds(context, node, offset, text.length)));
                } else {
    ...
    var createCJKCounter = function(value, numbers, multipliers, negativeSign, suffix, flags) {
        if (value < -9999 || value > 9999) return createCounterText(value, LIST_STYLE_TYPE.CJK_DECIMAL, suffix.length > 0);
            ...
            if (window && isElementNode(node) && (isHTMLElementNode(node) || isSVGElementNode(node))) {
                ...
                for(var child = node.firstChild; child; child = child.nextSibling){
                    if (!isElementNode(child) || !isScriptElement(child) && !child.hasAttribute(IGNORE_ATTRIBUTE) && (typeof this.options.ignoreElements !== 'function' || !this.options.ignoreElements(child))) {
                        if (!this.options.copyStyles || !isElementNode(child) || !isStyleElement(child)) clone.appendChild(this.cloneNode(child));
                    }
                }
                ...
                if (style && (this.options.copyStyles || isSVGElementNode(node)) && !isIFrameElement(node)) copyCSSStyles(style, clone);
    ...
    var calculateBackgroundPaintingArea = function(backgroundClip, element) {
        if (backgroundClip === BACKGROUND_CLIP.BORDER_BOX) return element.bounds;
                        ...
                        case 0:
                            ...
                            _loop_1 = function(backgroundImage) {
                                ...
                                return __generator(this, function(_h) {
                                    switch(_h.label){
                                        case 0:
                                            if (!(backgroundImage.type === CSSImageType.URL)) return [
                                                3 /*break*/ ,
                                                5
                                            ];
                                            image = void 0;
                ...
                return __generator(this, function(_a) {
                    switch(_a.label){
                        ...
                        case 3:
                            ...
                            border = borders_1[_i];
                            if (!(border.style !== BORDER_STYLE.NONE && !isTransparent(border.color) && border.width > 0)) return [
                                3 /*break*/ ,
                                11
                            ];
                            if (!(border.style === BORDER_STYLE.DASHED)) return [
                                3 /*break*/ ,
                                5
                            ];
                            return [
                        ...
                        case 5:
                            if (!(border.style === BORDER_STYLE.DOTTED)) return [
                                3 /*break*/ ,
                                7
                            ];
                            return [
                        ...
                        case 7:
                            if (!(border.style === BORDER_STYLE.DOUBLE)) return [
                                3 /*break*/ ,
                                9
                            ];
                            return [
        ...
        CanvasRenderer.prototype.renderDashedDottedBorder = function(color, width, side, curvePoints, style) {
            return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(_a) {
                    ...
                    this.ctx.beginPath();
                    if (style === BORDER_STYLE.DOTTED) this.formatPath(strokePaths);
                    ...
                    if (useLineDash) {
                        if (style === BORDER_STYLE.DOTTED) this.ctx.setLineDash([
                            0,
...
},{}]},["bsZ6J"], null, "parcelRequireb972")

//# sourceMappingURL=html2canvas.0afb955d.js.map
